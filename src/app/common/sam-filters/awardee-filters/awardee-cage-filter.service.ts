...
import { SDSAutocompleteServiceInterface, 
		 ...
		 SDSSelectedItemModel } from '@gsa-sam/components';

import { BaseAwardeeFilterService, EntityIDType } from './base-awardee-filter.service';

/**
 *  See the BaseAwardeeFilterService for the implementation.  This is a wrapper that gets awardee information by CAGE/NCAGE.
 */
@Injectable()
